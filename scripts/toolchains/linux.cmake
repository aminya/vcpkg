if(NOT _VCPKG_LINUX_TOOLCHAIN)
    ...
    string(APPEND CMAKE_CCXX_FLAGS_INIT " -fPIC -Wno-implicit-function-declaration -fvisibility=hidden -fvisibility-inlines-hidden ")
    string(APPEND CMAKE_C_FLAGS_INIT " -std=gnu17 ${CMAKE_CCXX_FLAGS_INIT} ${VCPKG_C_FLAGS} ")
    string(APPEND CMAKE_CXX_FLAGS_INIT " -std=gnu++20 ${CMAKE_CCXX_FLAGS_INIT} ${VCPKG_CXX_FLAGS} ")
    string(APPEND CMAKE_C_FLAGS_DEBUG_INIT " ${VCPKG_C_FLAGS_DEBUG} ")
    string(APPEND CMAKE_CXX_FLAGS_DEBUG_INIT " ${VCPKG_CXX_FLAGS_DEBUG} ")
    string(APPEND CMAKE_C_FLAGS_RELEASE_INIT " ${VCPKG_C_FLAGS_RELEASE} -ffile-prefix-map=${CMAKE_BINARY_DIR}=. -flto=thin ")
    string(APPEND CMAKE_CXX_FLAGS_RELEASE_INIT " ${VCPKG_CXX_FLAGS_RELEASE} -ffile-prefix-map=${CMAKE_BINARY_DIR}=. -flto=thin ")
