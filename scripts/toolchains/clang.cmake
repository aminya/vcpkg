...
if (NOT "${VCPKG_NO_LLVM_TOOLS}" STREQUAL "ON")
    set(VCPKG_DETECTED_CMAKE_SHARED_LINKER_FLAGS_RELEASE " ${VCPKG_DETECTED_CMAKE_SHARED_LINKER_FLAGS_RELEASE} -flto=thin ")
    set(VCPKG_DETECTED_CMAKE_STATIC_LINKER_FLAGS_RELEASE " ${VCPKG_DETECTED_CMAKE_STATIC_LINKER_FLAGS_RELEASE} -flto=thin ")
endif()